			...
			<div class="box">
				...
				<form action="customer_registration.php" method="post" enctype="multipart/form-data">
					...
					<div class="form-group">
						...
						<input type="text" name="c_email" required="" class="form-control" required="">
					</div>

					<div class="form-group">
						<label>Customer Password</label>
						<input type="text" name="c_padssword" required="" class="form-control">
					</div>
					<div class="form-group">
						<label>Country</label>
						<input type="text" name="c_country" required="" class="form-control" required="">
					</div>

					<div class="form-group">
						<label>City</label>
						<input type="text" name="c_city" required="" class="form-control" required="">
					</div>
					...
					<div class="form-group">
						...
						<input type="text" name="c_contactnumber" required="" class="form-control">
					</div>
					<div class="form-group">
						<label>Image</label>
						<input type="file" name="c_image" required="" class="form-control" required="">
					</div>
					<div class="form-group">
						<label>Address</label>
						<textarea class="form-control" name="c_address"></textarea>
					</div>
